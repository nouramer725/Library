...
//        return "account{" + "no_borrowed_books=" + no_borrowed_books + ", no_reserved_books=" + no_reserved_books + ", no_returned_books=" + no_returned_books + ", no_lost_books=" + no_lost_books + ", name=" + name + ", id=" + id + ", fine_amount=" + fine_amount + '}';
//    }
