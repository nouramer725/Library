...
public class book {
    ...
    public book(String title, String author, String ISBN, String publication, double price, String dueDate, boolean reserved, String feedback, boolean bookRequested, boolean renewInfo) {
        this.title = title;
        this.author = author;
        this.ISBN = ISBN;
   ...
   public void showDueDate() {
    ...
    public String toString() {
        return "book{" + "title=" + title + ", author=" + author + ", ISBN=" + ISBN + ", publication=" + publication + ", price=" + price + ", dueDate=" + dueDate + ", reserved=" + reserved + ", feedback=" + feedback + ", bookRequested=" + bookRequested + ", renewInfo=" + renewInfo + '}'+"\n";
    }
